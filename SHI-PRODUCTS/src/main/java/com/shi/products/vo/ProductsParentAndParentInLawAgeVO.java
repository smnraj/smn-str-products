 ...
 */
@Entity
@Table(name="SHI_PRODUCTS_PARENT_PARENTINLAW_AGE")
public class ProductsParentAndParentInLawAgeVO {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProductsParentAndParentInLawAgeVO other = (ProductsParentAndParentInLawAgeVO) obj;
	...
	public String toString() {
		return "ProductsParentAndParentInLawAgeVO [id=" + id + ", batchId=" + batchId + ", productCode=" + productCode
