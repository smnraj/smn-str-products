...
INSERT INTO SHI_PRODUCTS_SOURCE_SYSTEM (id, sourceSystem, productCode, productName, onlineDiscountPerc,
 prefixName, flag, isActive)
VALUES (1, 'star-purchase', 'MED-PRD-113', 'Medi classic Insurance Policy', '5', 'STAR_WEB', '0','TRUE'),
	   (2, 'star-purchase', 'MED-PRD-088', 'Star Comprehensive Insurance Policy', '5', 'STAR_WEB', '0','TRUE'),
	   (3, 'star-purchase', 'MED-PRD-091', 'Young Star Insurance Policy', '5', 'STAR_WEB', '0','TRUE'),
	   (4, 'star-purchase', 'MED-PRD-083', 'Arogya Sanjeevani Policy', '', 'STAR_WEB', '0','TRUE'),
	   (5, 'star-purchase', 'MED-PRD-119', 'Family Health Optima Insurance Plan', '', 'STAR_WEB', '0','TRUE'),
	   (6, 'star-purchase', 'MED-PRD-097', 'SUPER SURPLUS INDIVIDUAL', '5', 'STAR_WEB', '0','TRUE'),
	   (7, 'star-purchase', 'MED-PRD-098', 'SUPER SURPLUS FLOATER', '5', 'STAR_WEB', '0','TRUE'),
	   (8, 'star-purchase', 'MED-PRD-108', 'Star Women Care Insurance Policy', '5', 'STAR_WEB', '0','TRUE'),
	   (9, 'star-purchase', 'MED-PRD-109', 'Star Health Premier Insurance Policy', '', 'STAR_WEB', '0','TRUE'),
	   (10, 'star-purchase', 'MED-PRD-110', 'Star Health Assure Insurance Policy', '', 'STAR_WEB', '0','TRUE');
