...
ALTER TABLE SHI_PRODUCTS_GET_QUOTE_RESPONSE ADD COLUMN upfrontDiscountYN varchar(50);
ALTER TABLE SHI_PRODUCTS_GET_QUOTE_RESPONSE ADD COLUMN upfrontDiscountPerc varchar(50);
